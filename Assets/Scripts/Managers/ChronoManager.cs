...
namespace Chronoshift
{
    ...
    public class ChronoManager : MonoBehaviour
    {
        ...
        public class SpellHistoryManager
        {
            ...
            public Chronoshift.Spells.Spells _spell;

            public SpellHistoryManager(int id, Chronoshift.Spells.Spells spell)
            {
                ID_History = id;
                _spell = spell;
            }
        ...
        { //Note : add a lag at the end of the move before rewind
            ...
            {
                cm._spell.ChronoUse(cm.ID_History);
                yield return new WaitForSeconds(1);
