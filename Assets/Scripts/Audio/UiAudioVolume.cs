...
namespace Chronoshift.Audio
{
    public class UiAudioVolume : MonoBehaviour
    {
        ...
        {
            Chronoshift.Audio.SoundManagerV2.Instance.ChangeMusicVolume(_effectSlider.value);
        }
        public void MusicVolume()
        {
            Chronoshift.Audio.SoundManagerV2.Instance.ChangeEffectsVolume(_musicSlider.value);
        }
